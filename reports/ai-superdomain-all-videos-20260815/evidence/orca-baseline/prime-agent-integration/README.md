...
- generated production closure: 200 package rows and normalized lock SHA-256
  `db8b61f650a7d6832099e47d8a742c695bebb9277b1e67297f3636b916f2da06`.
...
the rename-before-fsync crash window. `recovery_conflict`, `rollback_failed`,
unknown, invalid, or multiple unresolved manifests block every later recovery
and install attempt for explicit review instead of being skipped.
...
The current unit suite has 54 tests, including deterministic runtime-command and
...
late-occupant, process-scan, unresolved-manifest, and interrupted-recovery fault
