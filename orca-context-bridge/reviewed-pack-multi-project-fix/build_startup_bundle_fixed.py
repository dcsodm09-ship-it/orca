...
def verify_reviewed_pack(
    ...
    if (
        set(payload) != {"schema_version", "authority", "pack", "shared_source_sha256s", "shared_source_policy", "authority_git", "content_source_closure"}
    ...
    # Check signature freshness to prevent self-signing
    ...
    # Check for self-signing markers
